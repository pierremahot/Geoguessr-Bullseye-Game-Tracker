...
<template>
  <div class="flex flex-col h-full">
    <div class="flex-grow overflow-auto custom-scrollbar rounded-lg border border-gray-700/50">
        ...
        <thead class="bg-gray-900/80 text-gray-100 uppercase font-medium tracking-wider sticky top-0 z-10 backdrop-blur-md">
          <tr v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id">
            <th
              ...
              :key="header.id"
              class="px-6 py-4 whitespace-nowrap border-b border-gray-700/50"
    ...
    <!-- Pagination -->
    <div class="flex items-center justify-between px-4 py-3 border-t border-gray-700 bg-gray-800/50 backdrop-blur-sm rounded-b-xl">
      <div class="flex items-center gap-2">
